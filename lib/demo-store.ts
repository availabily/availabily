...
const profiles: Profile[] = [
  {
    ...
    gallery_urls: [
      ...
      'https://images.unsplash.com/photo-1610647752706-3bb12232b3ab?w=800&h=600&fit=crop',
    ],
    ...
    prompt_blocks: [
      ...
      { id: 'pb-3', prompt: 'My style of service', answer: 'Detail-obsessed. I treat every car like it\'s mine — because I know how much it matters to you.' },
    ],
    created_at: new Date().toISOString(),
